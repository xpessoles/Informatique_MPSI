...
On dit qu'une telle solution est \textbf{maximale} s'il est
...
\textbf{On se placera dans ce cadre pour la suite de ce cours.
...
\begin{figure}[h!]
\begin{center}
\resizebox{0.6\textwidth}{!}{\input{images/euler-generique.pdf_t}}
...
\begin{figure}[h!]
\begin{center}
\includegraphics[width=.6\textwidth]{exp3.png}
...
\begin{figure}[!h]
    \begin{center}
        \includegraphics[width=.6\textwidth]{reaction_ordre1.png}
...
$    y''(t) = f(y(t),y'(t),t), \quad y(t_0) = y_0, y'(t_0) = z_0$, défini sur un intervalle de temps $I$ et où $t_0\in I$. 

L'idée est alors de \textbf{vectorialiser} cette équation, pour obtenir une équation \textbf{d'ordre 1} sur une variable vectorielle de \textbf{dimension 2}. 
Pour cela, on considère la variable $ X(t) = \bpm y(t) \\ y'(t) \epm$.

On a alors $    X'(t) = \bpm y'(t) \\ y''(t) \epm = \bpm y'(t) \\ f(y(t),y'(t),t) \epm$.
Avec      \fonction{F}{\R^2\times I}{\R^2}{\p{\bpm a\\b \epm , t }}{ \bpm b \\ f(a,b,t) \epm}$,
...
Considérons l'équation d'un système ressort-amortisseur : $  m y'' = - c y' - ky$,
...
\begin{figure}[!h]
    \begin{center}
        \includegraphics[width=.6\textwidth]{oscillateur_amorti_trajectoire.png}
...
\begin{figure}[!h]
    \begin{center}
        \includegraphics[width=.6\textwidth]{oscillateur_amorti_phase.png}
...
\begin{figure}[!h]
    \begin{center}
        \includegraphics[width=.6\textwidth]{oscillateur_amorti_odeint.png}
...
\begin{figure}[!h]
    \begin{center}
        \includegraphics[width=.6\textwidth]{oscillateur_amorti_pas.png}
