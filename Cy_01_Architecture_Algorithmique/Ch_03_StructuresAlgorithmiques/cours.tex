...
\begin{enumerate}
\item Résoudre ça mathématiquement, c'est-à-dire déterminer une expression de $u_n$ en fonction de 
...
Comme pour les boucles définies, nous sommes confrontés à un problème : comment démontrer un 
