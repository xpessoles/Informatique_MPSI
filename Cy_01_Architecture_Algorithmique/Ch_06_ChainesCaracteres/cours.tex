...
\section{Exercices}
%\begin{exo}
  \'Ecrire une fonction \pyv{c_recherche(m,s)} de recherche indiquant si le mot \pyv{m} est dans la chaîne \pyv{s} insensible à la casse (majuscules ou minuscules).
%\end{exo}

%\begin{exo}
  \'Ecrire une fonction \pyv{i_recherche(m,s)} de recherche du mot \pyv{m} dans une chaîne \pyv{s}, renvoyant la position de la première occurence du mot dans la chaîne et une erreur si le mot n'est pas dans le texte.
%\end{exo}

%\begin{exo}
  \'Ecrire une fonction \pyv{compte(m,s)} comptant le nombre d'occurences du mot \pyv{m} dans une chaîne \pyv{s}, chevauchements compris.
%\end{exo}

%\begin{exo}
  \'Ecrire une fonction \pyv{dist_compte(m,s)} comptant le nombre d'occurences du mot \pyv{m} dans une chaîne \pyv{s}, sans chevauchements.
%\end{exo} 