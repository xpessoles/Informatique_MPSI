...
\begin{defi}[Booléen\footnote{Le mot {booléen} a été donné en hommage au mathématicien 
...
tard. Il ne faut pas confondre \texttt{==} avec \texttt{=}, symbole de l'{affectation}.
...
programmation on {conseille} d'indenter les différents blocs afin de faciliter la lecture du 
code. En Python , l'indentation est {signifiante} : après le mot-clé \texttt{def}, chaque 
