...
On parle alors de \emph{tableaux dynamiques}.
...
\pyv{y}, et l'on dit que \pyv{x} et \pyv{y} sont des \emph{alias} de cette valeur. Réattribuer à 
...
\emph{alias} de cet objet là aussi. Mais si l'on modifie le contenu de \pyv{x}, sans réaffecter 
