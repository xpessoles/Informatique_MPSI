...
Si on a effectué des modifications, on peut les valider avec \pyv{conn.commit()}
ou les annuler avec \pyv{conn.rollback()}. 
Quand on a terminé, on peut fermer la connexion. Penser à valider les
changements auparavant s'il y en a : \pyv{conn.close()}.
