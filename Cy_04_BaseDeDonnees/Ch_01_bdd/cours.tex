...
\begin{center}
TO SOLVE %%%%\includegraphics[height=5cm]{films.png}
\end{center}
%\clearslide{}
...
Ce modèle à  base de tables, appelé \emph{modèle  logique des données}
...
\begin{center}
TO SOLVE %%\includegraphics[height=5cm]{films-id.png}
\end{center}
%\clearslide{}
...
% Mathématiquement:
% \begin{itemize}
% \item on dit qu'on a construit deux \emph{tables} $ noter les 
% \end{itemize}


% \emph{On appelle \emph{relation} $n$-aire }
