...
\graphicspath{{../../../style/png/}{images/}{../../../exos/consignes/consignes_tp14/}{../../../exos/sql/SQL-005/}}
\lstinputpath{{../../../exos/consignes/consignes_tp14/}{../../../exos/sql/SQL-005/}}
...
\def\xxnumpartie{5}
\def\xxpartie{Problèmes \& Exercices}
\def\xxdate{03 Juin 2020}

\def\xxchapitre{}
\def\xxnumchapitre{}
\def\xxnomchapitre{Problèmes \& Exercices}
\def\xxnumactivite{}
...
\def\xxtitreexo{Exercices issus de <<L'informatique pas à pas en prépa, éditions ellipses>>}
\def\xxsourceexo{\hspace{.2cm} \footnotesize{\textbf{Frédéric Butin}
}}
