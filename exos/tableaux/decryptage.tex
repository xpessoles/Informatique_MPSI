...
\question{Écrire la fonction \pyv{def generer_cle(mot:str,cle:str)->list } qui retourne la ligne << clé >> de la table \Ref{TabVig}.}
Le résultat sera de la forme suivante :



\question{Écrire une fonction étant spécifier ainsi : \pyv{code_vigenere(ch:str, cle:str) -> str } où la chaîne renvoyée correspond à la chaîne codée avec la clé \texttt{cle}.}
