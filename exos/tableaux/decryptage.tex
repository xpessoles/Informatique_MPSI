...
\question{Proposer ensuite l'algorithme de décryptage qui affiche le message crypté en clair, en supposant que $n$ est inconnue. L'utilisateur choisira parmi les décryptages proposés celui qui a du sens ! Coder cet algorithme en python et vérifier que vous arrivez bien à décrypter le message codé à la question précédente.}
