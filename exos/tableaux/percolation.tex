...
\question{Rédiger la fonction \pyv{proba(p,k,n)} qui prend en argument le nombre d'essai $k$, la variable $p$ ainsi que le nombre de cases $n$ sur la largeur et qui renvoie $P(p)$.}
