...
\question{} Écrire une fonction Python, appelée $\text{trapeze}$, en argument une fonction \pyv{f}, les variables \pyv{a} et \pyv{b} définissant le domaine d'intégration et le paramètre \pyv{n} définissant le nombre de subdivisions.
