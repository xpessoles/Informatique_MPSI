...
\begin{enumerate}[label=\emph{\alph*)}]
  \item Écrire  une fonction  \pyv{reste_a_payer(p, t,  m, d)}
...
restant d'un peu moins de $7,12$ euros.}
  \item Écrire une fonction \pyv{somme_totale_payee(p, t, m,
  d)} renvoyant la somme totale (mensualités plus le dernier
paiement) que vous aurez payé au banquier.
  \item Écrire une fonction \pyv{cout_total(p, t, m, d)} renvoyant
