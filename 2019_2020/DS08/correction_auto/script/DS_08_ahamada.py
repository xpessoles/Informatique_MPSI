...
## Question 14
Q14_req = "SELECT T_FACTURE.CLI_ID FROM T_FACTURE
EXCEPT
SELECT T_FACTURE.CLI_ID FROM T_FACTURE, T_LIGNE_FACTURE WHERE (LIF_REMISE_POURCENT>0 OR LIF_REMISE_MONTANT>0) AND T_FACTURE.FAC_ID=T_LIGNE_FACTURE.FAC_ID"
