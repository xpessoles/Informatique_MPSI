...
## Question 14
Q14_req = "select CLI_ID from T_FACTURE join T_LIGNE_FACTURE on T_FACTURE.FAC_ID=T_LIGNE_FACTURE.FAC_ID
 where LIF_REMISE_MONTANT < 122 and LIF_REMISE_POURCENT <88;"
