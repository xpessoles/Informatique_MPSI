...
## Question 14
Q14_req = "SELECT DISTINCT CLI_ID FROM T_FACTURE EXCEPT SELECT DISTINCT CLI_ID from T_FACTURE JOIN T_LIGNE_FACTURE on T_LIGNE_FACTURE.FAC_ID=T_FACTURE.FAC_ID where LIF_REMISE_POURCENT>0 or LIF_REMISE_MONTANT>0;"
