...
EXCEPT(SELECT T_facture.CLI_ID from T_FACTURE join T_LIGNE_FACTURE on T_LIGNE_FACTURE;FAC_ID=T_FACTURE.FAC_ID WHERE LIF_REMISE_MONTANT>0 or LIF_REMISE_POURCENT>0) "
