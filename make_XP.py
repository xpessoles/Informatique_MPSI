...
def genere_fichiers_tex(info_activite,type_activite):
    ...
    if type_activite=='cours':
        shutil.copyfile('style'+sep+'Cy_i_Ch_j_Cours.tex',rep+sep+'Cy_0'+str(n_cycle)+'_Ch_'+str(num_activite)+'_Cours.tex')
        shutil.copyfile('style'+sep+'Cy_i_Ch_j_Cours_PDF.tex',rep+sep+'Cy_0'+str(n_cycle)+'_Ch_'+str(num_activite)+'_Cours_PDF.tex')
        shutil.copyfile('style'+sep+'Cy_i_livret_Ch_j.tex',rep+sep+'Cy_0'+str(n_cycle)+'_livret_Ch_'+str(num_activite)+'.tex')
        shutil.copyfile('style'+sep+'Cy_i_Ch_j_TD_j.tex',rep+sep+'Cy_0'+str(n_cycle)+'_Ch_'+str(num_activite)+'_TD_'+str(num_activite)+'.tex')
        shutil.copyfile('style'+sep+'Cy_i_Ch_j_TD_k_cor_pdf.tex', rep+sep+'Cy_0'+str(n_cycle)+'_Ch_'+str(num_activite)+'_TD_'+str(num_activite)+'_cor_pdf.tex')
        shutil.copyfile('style'+sep+'Cy_i_Ch_j_TD_j_cor.tex',rep+sep+'Cy_0'+str(n_cycle)+'_Ch_'+str(num_activite)+'_TD_'+str(num_activite)+'_cor.tex')
        ...
        if os.path.exists(rep+sep+'Cy_0'+str(n_cycle)+'_Ch_'+str(num_chapitre)+'_TP_'+num_activite)==False:
            ...
            #TP : enonce
        shutil.copyfile('style'+sep+'Cy_i_Ch_j_TP_k.tex',rep+'/Cy_0'+str(n_cycle)+'_Ch_'+str(num_chapitre)+'_TP_'+num_activite+sep+'Cy_0'+str(n_cycle)+'_Ch_'+str(num_chapitre)+'_TP_'+num_activite+'.tex')
        shutil.copyfile('style'+sep+'Cy_i_Ch_j_TP_k_pdf.tex',rep+sep+'Cy_0'+str(n_cycle)+'_Ch_'+str(num_chapitre)+'_TP_'+num_activite+sep+'Cy_0'+str(n_cycle)+'_Ch_'+str(num_chapitre)+'_TP_'+num_activite+'_pdf.tex')
        ...
        shutil.copyfile('style'+sep+'DSk.tex',rep+sep+'DS'+num_ds_str+'.tex')
        shutil.copyfile('style'+sep+'DSk_pdf.tex',rep+sep+'DS'+num_ds_str+'_pdf.tex')
...
def genere_entete(rep,info_activite,type_activite):
    ...
    if type_activite=='cours':
        ...
        if os.path.exists(rep+sep+'td.tex')==False:
            shutil.copyfile('style/td0.tex',rep+sep+'td.tex')
...
def genere_pdf(file,rep,type_activite):
    ...
    for item in list_dir:
        if item.endswith(".aux") or item.endswith(".log") or item.endswith(".out") or item.endswith(".gz") or item.endswith(".toc") or item.endswith(".pytxcode") or item.endswith(".nav") or item.endswith(".snm") or item.endswith(".pdf") :
    ...
    if type_activite=='tp':
        ...
        list_dir = os.listdir(".")
        for item in list_dir:
            if item.endswith(".aux") or item.endswith(".log") or item.endswith(".out") or item.endswith(".gz") or item.endswith(".toc") or item.endswith(".pytxcode") or item.endswith(".nav") or item.endswith(".snm") or item.endswith(".pdf") or item.endswith(".idx") or item.endswith(".bcf") or item.endswith(".xml") :
                os.remove(os.path.join(".", item))
        os.system('rm *.aux')
        os.system('rm *.log')
        os.system('rm *.out')
